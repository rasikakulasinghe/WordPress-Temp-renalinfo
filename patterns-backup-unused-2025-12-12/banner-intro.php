<?php
/**
 * Title: Banner: Department Introduction
 * Slug: renalinfolk/banner-intro
 * Categories: banner, renalinfolk_medical_pages
 * Description: Large heading banner for department or service introduction pages.
 *
 * @package WordPress
	...
	<h2 class="wp-block-heading alignwide has-x-large-font-size">
		<?php
			printf(
				...
				esc_html_x( 'We\'re %s, our mission is to deliver exquisite flower arrangements that not only adorn living spaces but also inspire a deeper appreciation for natural beauty.', 'Pattern placeholder text.', 'renalinfolk' ),
