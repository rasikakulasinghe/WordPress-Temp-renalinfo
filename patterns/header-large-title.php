 ...
 * Slug: renalinfolk/header-large-title
 * Categories: header
...
<div class="wp-block-group" style="border-bottom-color:var(--wp--preset--color--accent-6);border-bottom-width:1px;padding-top:0;padding-bottom:0">
	...
	<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)">
		...
		<div class="wp-block-group" style="padding-right:0;padding-left:0">
			<!-- wp:navigation {"ariaLabel":"<?php esc_attr_e( 'Article Navigation', 'renalinfolk' ); ?>","overlayBackgroundColor":"base","overlayTextColor":"contrast","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","justifyContent":"right","orientation":"vertical"}} /-->
		</div>
		<!-- /wp:group -->
	</div>
	<!-- /wp:group -->
